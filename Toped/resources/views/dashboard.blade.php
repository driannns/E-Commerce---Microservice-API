    ...
    <div class="py-12 px-12">
        ...
        <div class="w-full flex items-center justify-center">
            <div class="w-9/12 border-2 border-[#41b547] flex items-center justify-between rounded-lg">
                <input type="text" name="search" class="w-full border-none focus:ring-0 focus:border-0  bg-transparent" placeholder="Search Product">
        ...
        <div class="">
            ...
            <div class="my-5 grid grid-cols-4 gap-5">
                ...
                <div class="card bg-white shadow-xl">
                    <figure><img class="p-3" src="{{ asset('storage/posts/' . $data->foto) }}" alt="Photo" /></figure>
